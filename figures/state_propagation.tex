\begin{tikzpicture}[
  ...
  labelnote/.style={align=center, fill=white, inner sep=1pt, font=\scriptsize, text width=28mm},
...
\node[labelnote] (l1) at (2.15,0.95) {conflicts, locality,\\queueing};
\node[labelnote] (l2) at (6.45,0.95) {cost, quality,\\resource usage};
\node[labelnote] (fb) at (4.3,2.2) {future hotspots,\\memory pressure};
...
\draw[arrow] (evo.north) to[out=150,in=30,looseness=1.15] (access.north);
